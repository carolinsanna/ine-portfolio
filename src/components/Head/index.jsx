export const Head = () => {
  return (
	<header className="grid lg:grid-rows-4 lg:grid-flow-col gap-10 mt-20 p-10 lg:mt-24 lg:pt-20">
		...
		<img src="src/assets/avatar.png" className="m-auto lg:order-last lg:row-span-4" alt="Inessa Luerce"/>
