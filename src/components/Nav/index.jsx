  ...
  return (
    <nav className="flex flex-col md:flex-row justify-between py-4 px-10 md:px-20 max-w-screen-xl mx-auto">
      <div className="grid grid-cols-3">
        ...
        <Logo
          className="block place-self-center w-12 h-12 md:w-16 md:h-16 dark:hidden"
          alt="Inessa Logo"
        />
        <LogoDark
          className="hidden place-self-center w-12 h-12 md:w-16 md:h-16 dark:block"
          alt="Inessa Logo"
        />
      </div>
      ...
      >
        <ul className="flex flex-col gap-4 text-ine-link-md text-ine-gray-900 dark:text-ine-gray-100 md:flex-row">
          <li className="px-2 py-3 self-center hover:text-ine-gray-500 md:self-center">
            <a href="./">Home</a>
          </li>
          <li className="px-2 py-3 self-center hover:text-ine-gray-500 md:self-center">
            <a href="/#work">Work</a>
